class CounterAnimation {
  constructor(elementId, startValue, endValue, duration = 4000) {
...
function initializeCounters() {
  ...
  new CounterAnimation('counter2', 0, 269, 3000);     // Counting up
  new CounterAnimation('counter3', 0, 100, 3000);  // Custom duration
  new CounterAnimation('counter4', 0, 127, 3000);  // Custom duration
  new CounterAnimation('counter5', 0, 113, 3000);  // Custom duration
  new CounterAnimation('counter6', 0, 24, 3000);  // Custom duration
